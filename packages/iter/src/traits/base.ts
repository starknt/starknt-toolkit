...
/**
 * Iterator trait base class.
 * Extend this class to create custom iterators.
 * This base class does not include adapter methods to avoid circular dependencies.
 */
export abstract class Iterator<const Item> implements IntoIterator<Item> {
   ...
   */
  // @ts-expect-error - This is a workaround to avoid circular dependencies.
